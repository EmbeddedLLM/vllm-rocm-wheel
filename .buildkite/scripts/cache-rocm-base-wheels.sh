...
#   PYTORCH_BRANCH     - PyTorch branch/tag (affects cache key)
#   TRITON_BRANCH      - Triton branch/tag (affects cache key)
...
generate_cache_key() {
    ...
    local args_string="${ROCM_VERSION:-}|${PYTORCH_BRANCH:-}|${TRITON_BRANCH:-}|${PYTHON_VERSION:-}"
